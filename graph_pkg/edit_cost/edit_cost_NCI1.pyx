cdef class EditCostNCI1(EditCost):
    ...
    cdef double c_cost_substitute_node(self, Node node_src, Node node_trgt):
        self.chem_source = node_src.label.chem
        self.chem_target = node_trgt.label.chem
