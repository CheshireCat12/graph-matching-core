...
@pytest.fixture()
def defined_graph():
    ged = GED(EditCost(1., 1., 1., 1., 'euclidean'))
    ...
    graph_source.add_node(Node(0, LabelNode(np.array([1.]))))
    graph_source.add_node(Node(1, LabelNode(np.array([2.]))))
    graph_source.add_node(Node(2, LabelNode(np.array([1.]))))
    graph_source.add_node(Node(3, LabelNode(np.array([3.]))))
    ...
    graph_target.add_node(Node(0, LabelNode(np.array([3.]))))
    graph_target.add_node(Node(1, LabelNode(np.array([2.]))))
    graph_target.add_node(Node(2, LabelNode(np.array([2.]))))
...
def test_real_graphs(test_graphs, idx_tr, idx_te, expected_dist):
    ged = GED(EditCost(1., 1., 1., 1., 'euclidean', alpha=0.8))
    dists = []
